                        ...
                        if (i > 0)
                        {
                            ...
                            else
                            {
                            	...
                            	if (this instanceof EntityPlayerSP) {
                            		yaw = EventRotation.currentRotations[0];
                            	}
                                targetEntity.addVelocity((double)(-MathHelper.sin(yaw * 0.017453292F) * (float)i * 0.5F), 0.1D, (double)(MathHelper.cos(yaw * 0.017453292F) * (float)i * 0.5F));
                            }
