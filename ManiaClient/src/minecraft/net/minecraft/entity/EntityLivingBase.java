...
import wtf.mania.event.impl.EventJump;
...
public abstract class EntityLivingBase extends Entity {
    ...
    public float y() {
        return this.isPotionActive(Potion.getPotionById(8)) ? getJumpUpwardsMotion() + (getActivePotionEffect(Potion.getPotionById(8)).getAmplifier() + 1) * 0.1F : getJumpUpwardsMotion();
    }
...
//            this.motionY += (double) ((float) (this.getActivePotionEffect(MobEffects.JUMP_BOOST).getAmplifier() + 1) * 0.1F);
    	...
    	if (isPlayer()) {
    		e = new EventJump(true, this.motionY).call();
