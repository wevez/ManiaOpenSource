...
import wtf.mania.module.impl.movement.SafeWalk;
...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_) {
        if (this.noClip) {
            ...
            //TODO
            if (((x == MoverType.SELF || x == MoverType.PLAYER) && this.onGround && (this.isSneaking() || SafeWalk.instance.toggled || (BlockFlyRecode.instance.toggled && BlockFlyRecode.safeWalk.value)) && this instanceof EntityPlayer)) {
            ...
            if (eventStep.stepHeight > 0.0F && flag && (d2 != p_70091_2_ || d4 != p_70091_6_)) {
                double d14 = p_70091_2_;
                double d6 = p_70091_4_;
                double d7 = p_70091_6_;
                AxisAlignedBB axisalignedbb1 = this.getEntityBoundingBox();
                this.setEntityBoundingBox(axisalignedbb);
                p_70091_4_ = eventStep.stepHeight;
    ...
    public void func_191958_b(float p_191958_1_, float p_191958_2_, float p_191958_3_, float p_191958_4_)
    {
    	...
    	if (this instanceof EntityPlayerSP) {
    		Strafe.sprintValue = true;
    		EventRotation event = new EventRotation(yaw, this.rotationPitch);
    		event.call();
    		if (Strafe.instance.toggled) yaw = event.yaw;
    	}
    	if ((this instanceof EntityPlayer) && Strafe.instance.toggled && yaw != this.rotationYaw) {
    		float preForward = p_191958_3_, preStrafe = p_191958_1_;
    		int dif = (int) ((MathHelper.wrapDegrees(this.rotationYaw - yaw - 23.5f - 135) + 180) / 45);
    		float strafe = p_191958_1_;
			float forward = p_191958_3_;
	        ...
	        if (calcForward > 0) {
	        	...
	        	Strafe.sprintValue = false;
	        }
	        if (KillAura.target != null && this.getDistanceToEntity(KillAura.target) < 0.5) calcForward = 0;
        	p_191958_1_ = calcStrafe;
	        p_191958_3_ = calcForward;
        }
    ...
    public EnumFacing getHorizontalFacing() {
        return EnumFacing.getHorizontal(MathHelper.floor((double) ((Strafe.instance.toggled?RotationUtils.serverRotations[0]:this.rotationYaw) * 4.0F / 360.0F) + 0.5D) & 3);
    }
