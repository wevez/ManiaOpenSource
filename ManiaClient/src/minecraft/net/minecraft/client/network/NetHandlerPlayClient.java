...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
        ...
        switch (spacketrecipebook$state) {
            ...
            case ADD:
                p_191980_1_.func_192595_a().forEach((p_194025_2_) ->
                {
                    ...
                    RecipeToast.func_193665_a(this.gameController.getToast(), p_194025_2_);
                });
        }
    ...
    public void handleUpdateScore(SPacketUpdateScore packetIn) {
    	if (this.clientWorldController.getScoreboard() == null) return;
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Scoreboard scoreboard = this.clientWorldController.getScoreboard();
            ...
            if (!(entity instanceof EntityLivingBase)) {
                ...
                for (SPacketEntityProperties.Snapshot spacketentityproperties$snapshot : packetIn.getSnapshots()) {
                    ...
                    if (iattributeinstance == null) {
                        iattributeinstance = abstractattributemap.registerAttribute(new RangedAttribute((IAttribute) null, spacketentityproperties$snapshot.getName(), 1.0D, 2.2250738585072014E-308D, Double.MAX_VALUE));
                    }
