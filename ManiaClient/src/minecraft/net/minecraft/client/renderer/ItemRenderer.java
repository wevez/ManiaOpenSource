...
import wtf.mania.module.impl.player.OldHitting;
...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (OldHitting.instance.toggled) {
           // GlStateManager.scale(1, 1, OldHitting.zPos.value * OldHitting.zPos.value);
           // GlStateManager.translate(OldHitting.xPos.value, -OldHitting.yPos.value, 0);
        }
        ...
        if (flag1 && !(itemStackOffHand.getItem() instanceof ItemShield && OldHitting.instance.toggled)) {
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.func_190926_b()) {
                ...
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                    ...
                    if (OldHitting.instance.toggled) {
                        if ((mc.gameSettings.keyBindUseItem.isKeyDown() || (KillAura.target != null && !KillAura.autoblockMode.is("None"))) && mc.player.getHeldItemMainhand().getItem() instanceof ItemSword) {
                           GlStateManager.scale(1.1, 1.1, 1.1);
                        	switch (OldHitting.animation.value) {
                                case "Vanilla":
                                ...
                                case "Leaked":
                                	 GlStateManager.rotate(var9, 1, 0, 0);
                                    this.transformFirstPersonItem(equipProgress, 0.0f);
                                    GlStateManager.translate(0, -var9 * 0.01, 0);
                                    GlStateManager.translate(0, 0, -var9 * 0.4);
                                    GlStateManager.rotate(var9 * 45, 0.5f, 1, 0.1f);
                                    //GlStateManager.rotate(var9 * 45,0, 0, -1f);
                                    this.func_178103_c();
                                    break;
                                case "Slide":
                                ...
                                case "Slide2":
                                	this.transformFirstPersonItem(equipProgress / 2, 0.0F);
                                    this.func_178103_c();
                                    GL11.glRotatef(-swingprogress * 120.0F / 2.0F, -8.0F, 0.0F, 9.0F);
                                    GL11.glRotatef(-swingprogress * 120.0F, 1.0F, -0.4F, -0.0F);
                                	break;
                            }
                        } else {
                ...
                if (OldHitting.instance.toggled) {
                	...
                	//GlStateManager.scale(OldHitting.itemSize.value, OldHitting.itemSize.value, OldHitting.itemSize.value);
                }
