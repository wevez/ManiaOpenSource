...
import wtf.mania.module.impl.combat.Reach;
import wtf.mania.module.impl.render.CameraNoClip;
import wtf.mania.module.impl.render.NoRender;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.world != null)
        {
            ...
            double d0 = Reach.instance.toggled ? Reach.currentReach : (double) this.mc.playerController.getBlockReachDistance();
            ...
            else if (d0 > 3.0D && !Reach.instance.toggled)
            {
                flag = true;
            }
    ...
    public void orientCamera(float partialTicks)
    {
        ...
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            else
            {
                ...
                if (!CameraNoClip.instance.toggled) {
                    for (int i = 0; i < 8; ++i)
                    {
...
//                this.itemRenderer.renderOverlays(p_renderHand_1_);
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        if (!NoRender.instance.toggled && NoRender.weather.value)
    ...
    {
    	if (NoRender.instance.toggled && NoRender.fog.value) return;
