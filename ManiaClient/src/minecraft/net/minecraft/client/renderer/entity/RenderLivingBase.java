...
import wtf.mania.module.impl.render.Chams;
import wtf.mania.module.impl.render.NameTags;
...
public abstract class RenderLivingBase<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, partialTicks, x, y, z))
        {
            ...
            try
            {
                ...
                float f7 = entity == Minecraft.getMinecraft().player ? entity.prevRotationPitchHead + (entity.rotationPitchHead - entity.prevRotationPitchHead) * partialTicks : entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTicks ;
    ...
    protected boolean canRenderName(T entity)
    {
        ...
        if (entity != entityplayersp)
        {
            ...
            if (entity instanceof EntityPlayer && NameTags.instance.toggled) {
            	return false;
            }
