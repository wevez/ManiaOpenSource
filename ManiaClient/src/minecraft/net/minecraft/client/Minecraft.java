...
//        frame.setSize(this.displayWidth, this.displayHeight);
...
//        Display.setParent(canvas);
    ...
    private void runGameLoop() throws IOException
    {
        ...
        if (!this.skipRenderWorld)
        {
            ...
            this.toast.func_191783_a(new ScaledResolution(this));
            this.mcProfiler.endSection();
        }
    ...
    private void runTickKeyboard() throws IOException
    {
        while (Keyboard.next())
        {
            ...
            if (flag)
            {
                ...
                if (this.currentScreen == null)
                {
                	Mania.instance.keybindManager.onKeydown(i);
                	new EventKey(i).call();
                	if (i == 1)
                    {
