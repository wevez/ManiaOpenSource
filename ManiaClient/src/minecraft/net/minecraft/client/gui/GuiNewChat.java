...
/*
 * SmoothChat By LlamaLad7
 * https://github.com/LlamaLad7/Better-Chat
 */
                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                ...
                                drawRect(0, j2 - this.mc.fontRendererObj.FONT_HEIGHT, 324, j2, 0x77222222);
