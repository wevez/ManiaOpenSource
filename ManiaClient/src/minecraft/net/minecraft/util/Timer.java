...
public class Timer {
    ...
    public void updateTimer() {
        ...
        this.elapsedPartialTicks = (float) ((double) this.elapsedPartialTicks + d2 * (double) (Minecraft.getMinecraft().world == null ? 20 : this.timerSpeed   * (double) this.ticksPerSecond));
