...
public abstract class Enchantment
{
    ...
    public static final int protection = 0, fireProtection = 1, featherFalling = 2, blastProtection = 3, projectileProtection = 4, respiration = 5, aquaAffinity = 6,
    		thorns = 7, depthStrider = 8, frostWalker = 9, sharpness = 16, smite = 17, baneOfArthropods = 18, knocback = 19, fireAspect = 20, looting = 21,
    		efficiency = 32, silkTouch = 33, unbreaking = 34, fortune = 35, power = 48, punch = 49, flame = 50, infinity = 51, luckOfTheSea = 61, lure = 62, meanding = 70;
