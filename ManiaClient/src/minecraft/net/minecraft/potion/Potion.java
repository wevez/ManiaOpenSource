...
public class Potion
{
    ...
    public static int speed = 1, slowness = 2, haste = 3, miningFatigue = 4, strength = 5, instantHeal = 6, instantDamage = 7, jumpBoost = 8, nausea = 9, regeneration = 10,
    		resistance = 11, fireResistance = 12, waterBreathing = 13, invisibility = 14, blindness = 15, nightVision = 16, hunger = 17, weakness = 18, poison = 19, wither = 20,
    		healthBoost = 21, absorption = 22, saturation = 23, glowing = 24, levitation = 25, luck = 26, unluck = 27;
