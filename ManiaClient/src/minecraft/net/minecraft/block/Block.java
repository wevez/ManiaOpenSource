...
import wtf.mania.event.impl.EventBlockCollision;
import wtf.mania.module.impl.movement.Jesus;
import wtf.mania.module.impl.render.XRay;
...
public class Block
{
    ...
    {
    	addCollisionBoxToList(pos, entityBox, collidingBoxes, Jesus.can() && this instanceof BlockLiquid?new AxisAlignedBB(0, 0, 0, 1, .76637, 1):state.getCollisionBoundingBox(worldIn, pos));
    }
    ...
    {
    	EventBlockCollision event = new EventBlockCollision(pos, blockBox, true);
    	event.call();
    	blockBox = event.axisAlignedBB;
