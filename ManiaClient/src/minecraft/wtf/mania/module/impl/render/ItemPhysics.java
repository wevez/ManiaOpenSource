...
public class ItemPhysics extends Module {
	...
	public ItemPhysics() {
		super("ItemPhysics", "Makes item real", ModuleCategory.Render, false);
		instance = this;
	}
    ...
    public static void doRender(Entity par1Entity, double x, double y, double z, float par8, float par9) {
        ...
        if (itemstack.getItem() != null) {
            ThreadLocalRandom.current().setSeed(187L);
            ...
            if (!Double.isNaN(entityitem.posX) && !Double.isNaN(entityitem.posY) && !Double.isNaN(entityitem.posZ) && entityitem.world != null) {
                if (entityitem.onGround) {
                    ...
                    blockpos1.add(0, 1, 0);
                    Material material = entityitem.world.getBlockState(blockpos1).getBlock().getMaterial(entityitem.world.getBlockState(blockpos1));
                    Material material1 = entityitem.world.getBlockState(blockpos).getBlock().getMaterial(entityitem.world.getBlockState(blockpos));
