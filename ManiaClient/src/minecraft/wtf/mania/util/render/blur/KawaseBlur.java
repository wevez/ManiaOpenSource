...
public class KawaseBlur implements MCHook {
    ...
    public static ShaderUtil kawaseDown = new ShaderUtil("skidmomento/kawaseDown.frag");
    public static ShaderUtil kawaseUp = new ShaderUtil("skidmomento/kawaseUp.frag");
    ...
    private static void initFramebuffers(float iterations) {
        ...
        framebufferList.add(BlurUtils.createFrameBuffer(framebuffer));
    ...
    public static void renderBlur(int iterations, int offset) {
        ...
        BlurUtils.bindTexture(framebufferList.get(1).framebufferTexture);
        kawaseUp.init();
        kawaseUp.setUniformf("offset", offset, offset);
    ...
    private static void renderFBO(Framebuffer framebuffer, int framebufferTexture, ShaderUtil shader, float offset) {
        ...
        shader.init();
        BlurUtils.bindTexture(framebufferTexture);
