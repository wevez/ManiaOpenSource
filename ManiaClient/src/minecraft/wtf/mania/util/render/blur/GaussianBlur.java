...
public class GaussianBlur implements MCHook {

    public static ShaderUtil blurShader = new ShaderUtil("skidmomento/gaussian.frag");
    ...
    public static void renderBlur(float radius) {
        ...
        BlurUtils.bindTexture(mc.getFramebuffer().framebufferTexture);
