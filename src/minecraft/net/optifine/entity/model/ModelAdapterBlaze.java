...
public class ModelAdapterBlaze extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                return (ModelRenderer)Reflector.getFieldValue(modelblaze, ModelBlaze.class, ModelRenderer.class, 0);
            }
            else
            {
                String s = "stick";
                ...
                {
                    ModelRenderer[] amodelrenderer = (ModelRenderer[])((ModelRenderer[])Reflector.getFieldValue(modelblaze, ModelBlaze.class, ModelRenderer[].class, 0));
