...
public class ModelAdapterMagmaCube extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                return (ModelRenderer)Reflector.getFieldValue(modelmagmacube, ModelMagmaCube.class, ModelRenderer.class, 0);
            }
            else
            {
                String s = "segment";
                ...
                {
                    ModelRenderer[] amodelrenderer = (ModelRenderer[])((ModelRenderer[])Reflector.getFieldValue(modelmagmacube, ModelMagmaCube.class, ModelRenderer[].class, 0));
