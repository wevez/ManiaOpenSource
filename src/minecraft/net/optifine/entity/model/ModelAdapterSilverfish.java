...
public class ModelAdapterSilverfish extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                ModelRenderer[] amodelrenderer1 = (ModelRenderer[])((ModelRenderer[])Reflector.getFieldValue(modelsilverfish, ModelSilverfish.class, ModelRenderer[].class, 0));
            ...
            else
            {
                ...
                {
                    ModelRenderer[] amodelrenderer = (ModelRenderer[])((ModelRenderer[])Reflector.getFieldValue(modelsilverfish, ModelSilverfish.class, ModelRenderer[].class, 0));
