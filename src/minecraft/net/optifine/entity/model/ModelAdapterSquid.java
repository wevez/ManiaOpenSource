...
public class ModelAdapterSquid extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                return (ModelRenderer)Reflector.getFieldValue(modelsquid, ModelSquid.class, ModelRenderer.class, 0);
            }
            else
            {
                String s = "tentacle";
                ...
                {
                    ModelRenderer[] amodelrenderer = (ModelRenderer[])((ModelRenderer[])Reflector.getFieldValue(modelsquid, ModelSquid.class, ModelRenderer[].class, 0));
