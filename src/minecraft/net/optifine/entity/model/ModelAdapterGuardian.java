...
public class ModelAdapterGuardian extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                return (ModelRenderer)Reflector.getFieldValue(modelguardian, ModelGuardian.class, ModelRenderer.class, 0);
            }
            else if (modelPart.equals("eye"))
            {
                return (ModelRenderer)Reflector.getFieldValue(modelguardian, ModelGuardian.class, ModelRenderer.class, 1);
            }
            else
            {
                String s = "spine";
                ...
                {
                    ModelRenderer[] amodelrenderer1 = (ModelRenderer[])((ModelRenderer[])Reflector.getFieldValue(modelguardian, ModelGuardian.class, ModelRenderer[].class, 0));
                ...
                else
                {
                    ...
                    {
                        ModelRenderer[] amodelrenderer = (ModelRenderer[])((ModelRenderer[])Reflector.getFieldValue(modelguardian, ModelGuardian.class, ModelRenderer[].class, 1));
