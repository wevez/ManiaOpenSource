...
public class ModelAdapterGhast extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                return (ModelRenderer)Reflector.getFieldValue(modelghast, ModelGhast.class, ModelRenderer.class, 0);
            }
            else
            {
                String s = "tentacle";
                ...
                {
                    ModelRenderer[] amodelrenderer = (ModelRenderer[])((ModelRenderer[])Reflector.getFieldValue(modelghast, ModelGhast.class, ModelRenderer[].class, 0));
