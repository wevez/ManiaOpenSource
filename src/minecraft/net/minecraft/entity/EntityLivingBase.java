...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void onEntityUpdate()
    {
        ...
        this.prevRotationPitchHad = this.rotationPitchHead;
    ...
    protected float updateDistance(float p_110146_1_, float p_110146_2_)
    {
        ...
        float f1 = MathHelper.wrapDegrees((this == Minecraft.getMinecraft().player ? RotationUtil.currentRotation[0] : this.rotationYaw) - this.renderYawOffset);
        ...
        this.renderYawOffset = (this == Minecraft.getMinecraft().player ? RotationUtil.currentRotation[0] : this.rotationYaw) - f1;
    ...
    {
        return this.getVectorForRotation(RotationUtil.serverRotation[1], RotationUtil.serverRotation[0]);
    }
