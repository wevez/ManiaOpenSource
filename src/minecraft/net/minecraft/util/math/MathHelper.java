...
public class MathHelper
{
    ...
    public static double gcd(double num, double gcd) {
    	return num - num % gcd;
    }
    
    public static float gcd(float num, float gcd) {
    	return num - num % gcd;
    }
    
    public static double reverse_clamp(double num, double min, double max) {
