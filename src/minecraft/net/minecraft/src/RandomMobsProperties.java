...
public class RandomMobsProperties
{
    ...
    public RandomMobsProperties(String p_i67_1_, ResourceLocation[] p_i67_2_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i67_1_);
        this.basePath = connectedparser.parseBasePath(p_i67_1_);
        this.resourceLocations = p_i67_2_;
    }

    public RandomMobsProperties(Properties p_i68_1_, String p_i68_2_, ResourceLocation p_i68_3_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i68_2_);
        this.basePath = connectedparser.parseBasePath(p_i68_2_);
        this.rules = this.parseRules(p_i68_1_, p_i68_3_, connectedparser);
    }
