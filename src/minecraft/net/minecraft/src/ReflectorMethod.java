...
public class ReflectorMethod
{
    ...
    public ReflectorMethod(ReflectorClass p_i76_1_, String p_i76_2_)
    {
        this(p_i76_1_, p_i76_2_, (Class[])null, false);
    }

    public ReflectorMethod(ReflectorClass p_i77_1_, String p_i77_2_, Class[] p_i77_3_)
    {
        this(p_i77_1_, p_i77_2_, p_i77_3_, false);
    }

    public ReflectorMethod(ReflectorClass p_i78_1_, String p_i78_2_, Class[] p_i78_3_, boolean p_i78_4_)
    {
        ...
        this.targetMethodName = p_i78_2_;
        this.targetMethodParameterTypes = p_i78_3_;
