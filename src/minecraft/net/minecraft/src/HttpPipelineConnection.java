...
public class HttpPipelineConnection
{
    ...
    public HttpPipelineConnection(String p_i45_1_, int p_i45_2_)
    {
        this(p_i45_1_, p_i45_2_, Proxy.NO_PROXY);
    }

    public HttpPipelineConnection(String p_i46_1_, int p_i46_2_, Proxy p_i46_3_)
    {
        this.host = null;
        this.port = 0;
