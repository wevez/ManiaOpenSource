...
public class PlayerItemModel
{
    ...
    public PlayerItemModel(Dimension p_i63_1_, boolean p_i63_2_, PlayerItemRenderer[] p_i63_3_)
    {
        this.textureSize = p_i63_1_;
        this.usePlayerTexture = p_i63_2_;
        this.modelRenderers = p_i63_3_;
    }
