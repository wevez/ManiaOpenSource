...
public class WorldServerOF extends WorldServer
{
    ...
    public WorldServerOF(MinecraftServer p_i83_1_, ISaveHandler p_i83_2_, WorldInfo p_i83_3_, int p_i83_4_, Profiler p_i83_5_)
    {
        super(p_i83_1_, p_i83_2_, p_i83_3_, p_i83_4_, p_i83_5_);
        this.mcServer = p_i83_1_;
    }
