...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
	{
		...
		{
			this.buttonList.add(new GuiButton(14, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("AltManager", new Object[0])));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		String s = Nazo.CLIENT_NAME + " " + Nazo.CLIENT_VERSION + " | " + Nazo.CLIENT_AUTHOR;
		...
		GlStateManager.pushMatrix();
        Gui.drawCenteredString(mc.fontRendererObj, "Nazo", (int) (this.width / 2F), 50, -765);
		GlStateManager.popMatrix();

		if(HWIDUtils.status.equals("Dev") || HWIDUtils.status.equals("Special") || HWIDUtils.status.equals("Owner") || HWIDUtils.status.equals("Parent")) {
			this.drawString(this.fontRendererObj, "Welcome, " + EnumChatFormatting.RED + HWIDUtils.name + ChatFormatting.GRAY + "(" + HWIDUtils.status + ")", this.width - this.fontRendererObj.getStringWidth("Welcome, " + EnumChatFormatting.RED + ChatFormatting.GRAY + HWIDUtils.name + "(" + HWIDUtils.status + ")") - 2, this.height - 10, -1);
		} else if(HWIDUtils.status.equals("Free")) {
			this.drawString(this.fontRendererObj, "Welcome, " + EnumChatFormatting.BLUE + HWIDUtils.name + "(" + HWIDUtils.status + ")", this.width - this.fontRendererObj.getStringWidth("Welcome, " + EnumChatFormatting.GRAY + HWIDUtils.name + "(" + HWIDUtils.status + ")") - 2, this.height - 10, -1);
		} else {
			this.drawString(this.fontRendererObj, "Welcome, " + EnumChatFormatting.GREEN + HWIDUtils.name + ChatFormatting.GRAY + "(" + HWIDUtils.status + ")", this.width - this.fontRendererObj.getStringWidth("Welcome, " + EnumChatFormatting.GREEN + ChatFormatting.GRAY + HWIDUtils.name + "(" + HWIDUtils.status + ")") - 2, this.height - 10, -1);
		}
