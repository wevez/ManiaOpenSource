...
import nazo.Nazo;
import nazo.management.gui.login.GuiHwidLogin;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new GuiHwidLogin(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new GuiHwidLogin());
        }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading "+Nazo.CLIENT_NAME+" | by "+Nazo.CLIENT_AUTHOR);
